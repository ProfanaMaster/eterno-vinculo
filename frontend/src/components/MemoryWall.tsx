      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 bg-white z-[9999] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-gradient-to-r from-white/98 via-purple-50/95 to-white/98 backdrop-blur-sm border-b border-purple-200/50 p-4 z-[9998] shadow-sm">
              <button
